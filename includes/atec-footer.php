...
<div class="atec-footer atec-center atec-fs-12">
	<span class="atec-ml-10" style="float:left;">
		...
		</span> &middot; <a class="atec-nodeco" href="',esc_url(get_admin_url().'admin.php?page=atec_group'),'">atec-',  esc_attr__('plugins','atec-database'), ' – ', esc_attr__('Dashboard','atec-database'), '</a>
	</span>
